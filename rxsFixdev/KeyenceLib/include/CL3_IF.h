...
extern "C"
{
	...
	CL3_IF_API LONG WINAPI CL3IF_GetHeadAlignLevel(LONG deviceId, BYTE headNo1, BYTE headNo2, LONG* optAxis1, LONG* optAxis2, LONG* optAxis3, LONG* optAxis4, LONG* total);
