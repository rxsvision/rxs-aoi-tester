...
EXPORT int dwg_read_file (const char *__restrict filename,
                          Dwg_Data *__restrict dwg);
EXPORT int dxf_read_file (const char *__restrict filename,
                          Dwg_Data *__restrict dwg);
// You might need to probe for that.
EXPORT int dwg_write_file (const char *__restrict filename,
                           const Dwg_Data *__restrict dwg);

/* Supports multiple preview picture types.
   Currently 3 types: BMP 2, WMF 3 and PNG as type 6.
   Returns the size of the image.
 */
EXPORT unsigned char *dwg_bmp (const Dwg_Data *__restrict dwg,
                               BITCODE_RL *__restrict size,
                               BITCODE_RC *__restrict typep);
 ...
 */
EXPORT BITCODE_H
dwg_ctrl_table (Dwg_Data *__restrict dwg, const char *__restrict table);

/* Search for the name in the associated table, and return its handle. Search
 * is case-insensitive.
 * Both name and table are ascii.
 */
EXPORT BITCODE_H dwg_find_tablehandle (Dwg_Data *__restrict dwg,
                                       const char *__restrict name,
                                       const char *__restrict table);
EXPORT BITCODE_H dwg_find_tablehandle_index (Dwg_Data *__restrict dwg,
                                             const int index,
                                             const char *__restrict table);

/* Search for handle in associated table, and return its name (as UTF-8) */
EXPORT char *
dwg_handle_name (Dwg_Data *__restrict dwg, const char *__restrict table,
                 const BITCODE_H __restrict handle);
 ...
 *  table is ascii.
 */
EXPORT BITCODE_H dwg_find_table_control (Dwg_Data *__restrict dwg,
                                         const char *__restrict table);
 ...
 *  Name is ascii.
 */
EXPORT BITCODE_H dwg_find_dictionary (Dwg_Data *__restrict dwg,
                                      const char *__restrict name);
/** Search for a named dictionary entry in the given dict.
 *  Search is case-sensitive. name is ASCII. */
EXPORT BITCODE_H dwg_find_dicthandle (Dwg_Data *__restrict dwg, BITCODE_H dict,
                                      const char *__restrict name);
/** Search all dictionary entries in the given dict.
 *  Check for the matching name of the handle object. (Control lists).
 *  Search is case-insensitive */
EXPORT BITCODE_H dwg_find_dicthandle_objname (Dwg_Data *__restrict dwg, BITCODE_H dict,
                                              const char *__restrict name);
/* Search for a table EXTNAME */
EXPORT char *dwg_find_table_extname (Dwg_Data *__restrict dwg,
                                     Dwg_Object *__restrict obj);
/* Returns the string value of the member of the AcDbVariableDictionary.
   The name is ascii. E.g. LIGHTINGUNITS => "0" */
EXPORT char *dwg_variable_dict (Dwg_Data *__restrict dwg,
                                const char *__restrict name);

EXPORT double dwg_model_x_min (const Dwg_Data *__restrict);
EXPORT double dwg_model_x_max (const Dwg_Data *__restrict);
EXPORT double dwg_model_y_min (const Dwg_Data *__restrict);
EXPORT double dwg_model_y_max (const Dwg_Data *__restrict);
EXPORT double dwg_model_z_min (const Dwg_Data *__restrict);
EXPORT double dwg_model_z_max (const Dwg_Data *__restrict);
EXPORT double dwg_page_x_min (const Dwg_Data *__restrict);
EXPORT double dwg_page_x_max (const Dwg_Data *__restrict);
EXPORT double dwg_page_y_min (const Dwg_Data *__restrict);
EXPORT double dwg_page_y_max (const Dwg_Data *__restrict);

EXPORT Dwg_Object_BLOCK_CONTROL * dwg_block_control (Dwg_Data *__restrict dwg);

EXPORT Dwg_Object_Ref * dwg_model_space_ref (Dwg_Data *__restrict dwg);
EXPORT Dwg_Object_Ref * dwg_paper_space_ref (Dwg_Data *__restrict dwg);
EXPORT Dwg_Object * dwg_model_space_object (Dwg_Data *__restrict dwg);
EXPORT Dwg_Object * dwg_paper_space_object (Dwg_Data *__restrict dwg);

EXPORT unsigned int dwg_get_layer_count (const Dwg_Data *__restrict dwg);

EXPORT Dwg_Object_LAYER ** dwg_get_layers (const Dwg_Data *__restrict dwg);

EXPORT BITCODE_BL dwg_get_num_objects (const Dwg_Data *__restrict dwg);

EXPORT BITCODE_BL dwg_get_object_num_objects (const Dwg_Data *__restrict dwg);

EXPORT int dwg_class_is_entity (const Dwg_Class *__restrict klass);

EXPORT int dwg_obj_is_control (const Dwg_Object *__restrict obj);
EXPORT int dwg_obj_is_table (const Dwg_Object *__restrict obj);
EXPORT int dwg_obj_is_subentity (const Dwg_Object *__restrict obj);
EXPORT int dwg_obj_has_subentity (const Dwg_Object *__restrict obj);
EXPORT int dwg_obj_is_3dsolid (const Dwg_Object *__restrict obj);
EXPORT int dwg_obj_is_acsh (const Dwg_Object *__restrict obj);

EXPORT BITCODE_BL dwg_get_num_entities (const Dwg_Data *__restrict);

EXPORT Dwg_Object_Entity **dwg_get_entities (const Dwg_Data *__restrict);

EXPORT Dwg_Object_LAYER *
dwg_get_entity_layer (const Dwg_Object_Entity *__restrict);
...
EXPORT Dwg_Object *dwg_ref_object (Dwg_Data *__restrict dwg,
                                   Dwg_Object_Ref *__restrict ref);
EXPORT Dwg_Object *dwg_ref_object_relative (Dwg_Data *__restrict dwg,
                                            Dwg_Object_Ref *__restrict ref,
                                            const Dwg_Object *__restrict obj);
EXPORT Dwg_Object *dwg_ref_object_silent (Dwg_Data *__restrict dwg,
                                          Dwg_Object_Ref *__restrict ref);

EXPORT Dwg_Object *get_first_owned_entity (const Dwg_Object *__restrict hdr);
EXPORT Dwg_Object *get_next_owned_entity (const Dwg_Object *__restrict hdr,
                                          const Dwg_Object *__restrict current);
EXPORT Dwg_Object *get_first_owned_subentity (const Dwg_Object *__restrict owner);
EXPORT Dwg_Object *
get_next_owned_subentity (const Dwg_Object *__restrict owner,
                          const Dwg_Object *__restrict current);
EXPORT Dwg_Object *get_first_owned_block (const Dwg_Object *hdr);
EXPORT Dwg_Object *get_last_owned_block (const Dwg_Object *hdr);
EXPORT Dwg_Object *get_next_owned_block (const Dwg_Object *__restrict hdr,
                                         const Dwg_Object *__restrict current);
EXPORT Dwg_Object *get_next_owned_block_entity (const Dwg_Object *__restrict hdr,
                                                const Dwg_Object *__restrict current);
...
EXPORT Dwg_Object *dwg_resolve_handle (const Dwg_Data *__restrict dwg,
                                       BITCODE_RLL absref);
EXPORT Dwg_Object *dwg_resolve_handle_silent (const Dwg_Data *__restrict dwg,
                                              const BITCODE_RLL absref);
EXPORT int dwg_resolve_handleref (Dwg_Object_Ref *__restrict ref,
                                  const Dwg_Object *__restrict obj);

EXPORT Dwg_Object *dwg_resolve_jump (const Dwg_Object *obj);
EXPORT Dwg_Section_Type dwg_section_type (const char *__restrict name);
EXPORT Dwg_Section_Type dwg_section_wtype (const DWGCHAR *__restrict wname);
...
*/
EXPORT void dwg_free (Dwg_Data *__restrict dwg);

/** Free the object (all three structs and its fields)
*/
EXPORT void dwg_free_object (Dwg_Object *__restrict obj);

/** Add the empty ref to the DWG (freshly malloc'ed), or NULL.
*/
EXPORT Dwg_Object_Ref * dwg_new_ref (Dwg_Data *__restrict dwg);

/** For encode:
 *  May need obj to shorten the code to a relative offset, but not in header_vars.
 *  There obj is NULL.
 */
EXPORT int dwg_add_handle (Dwg_Handle *__restrict hdl, const BITCODE_RC code,
...
/** Returns an existing ref with the same ownership (hard/soft, owner/pointer)
    ...
    always absolute.
*/
EXPORT Dwg_Object_Ref *dwg_add_handleref (Dwg_Data *__restrict dwg,
                                          const BITCODE_RC code,
                                          const BITCODE_RLL value,
                                          const Dwg_Object *__restrict obj);
/** Return a link to the global ref or a new one. Or a NULLHDL. */
EXPORT Dwg_Object_Ref *
dwg_dup_handleref (Dwg_Data *__restrict dwg, const Dwg_Object_Ref *__restrict ref);
...
/* to read and write */
EXPORT int dwg_supports_obj (const Dwg_Data *__restrict dwg,
                             const Dwg_Object *__restrict obj);
EXPORT void dwg_errstrings (int error);

EXPORT char *dwg_encrypt_SAT1 (BITCODE_BL blocksize,
                               BITCODE_RC *__restrict acis_data,
                               int *__restrict acis_data_offset);
...
EXPORT int dwg_convert_SAB_to_SAT1 (Dwg_Entity_3DSOLID *__restrict _obj);
...
*/
EXPORT int dwg_add_object (Dwg_Data *__restrict dwg);
...
EXPORT int dwg_object_name (const char *const __restrict name, // in
                            const char **__restrict dxfnamep,  // out, maybe NULL
                            Dwg_Object_Type *__restrict typep, // out, maybe NULL
                            int *__restrict is_entp,           // out, maybe NULL
                            Dwg_Class_Stability *__restrict stabilityp); // out, maybe NULL
