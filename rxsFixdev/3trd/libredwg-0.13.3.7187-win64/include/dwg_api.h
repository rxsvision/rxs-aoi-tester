...
#  define LOG_ERROR(msg, name, type) fprintf (stderr, msg, name, (type))
  ...
  /** Returns the HEADER.fieldname value in out.
     ...
     dynapi.c
   */
  EXPORT bool dwg_dynapi_header_value (const Dwg_Data *__restrict dwg,
                                       const char *__restrict fieldname,
                                       void *__restrict out,
                                       Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3));
   ...
   */
  EXPORT bool
  dwg_dynapi_entity_value (void *__restrict entity, const char *__restrict dxfname,
                           const char *__restrict fieldname, void *__restrict out,
                           Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3, 4));
   ...
   */
  EXPORT bool
  dwg_dynapi_common_value (void *__restrict _obj, const char *__restrict fieldname,
                           void *__restrict out, Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3));
   ...
   */
  EXPORT bool dwg_dynapi_subclass_value (const void *__restrict ptr,
                                         const char *__restrict subclass,
                                         const char *__restrict fieldname,
                                         void *__restrict out,
                                         Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3, 4));
  ...
  EXPORT bool dwg_dynapi_header_utf8text (const Dwg_Data *__restrict dwg,
                                          const char *__restrict fieldname,
                                          char **__restrict textp, int *isnewp,
                                          Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3));
  ...
  /** Returns the ENTITY|OBJECT.fieldname text value in textp as utf-8.
     ...
     (r2007+), otherwise 0
  */
  EXPORT bool dwg_dynapi_entity_utf8text (void *__restrict entity,
                                          const char *__restrict name,
                                          const char *__restrict fieldname,
                                          char **__restrict textp, int *isnewp,
                                          Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3, 4));
  EXPORT bool dwg_dynapi_common_utf8text (void *__restrict _obj,
                                          const char *__restrict fieldname,
                                          char **__restrict textp, int *isnewp,
                                          Dwg_DYNAPI_field *__restrict fp)
      __nonnull ((1, 2, 3));
   ...
   */
  EXPORT bool dwg_dynapi_header_set_value (Dwg_Data *__restrict dwg,
                                           const char *__restrict fieldname,
  ...
  /** Sets the ENTITY.fieldname to a value.
      ...
      converted to TV or TU.
   */
  EXPORT bool dwg_dynapi_entity_set_value (void *__restrict entity,
                                           const char *__restrict dxfname,
                                           const char *__restrict fieldname,
                                           const void *__restrict value,
                                           const bool is_utf8)
      __nonnull ((1, 2, 3, 4));
  ...
  /** Sets the common ENTITY or OBJECT.fieldname to a value.
      ...
      converted to TV or TU.
   */
  EXPORT bool dwg_dynapi_common_set_value (void *__restrict _obj,
                                           const char *__restrict fieldname,
                                           const void *__restrict value,
                                           const bool is_utf8)
      __nonnull ((1, 2, 3));
  ...
  */
  EXPORT char *dwg_dynapi_handle_name (const Dwg_Data *__restrict dwg,
                                       Dwg_Object_Ref *__restrict hdl,
                                       int *alloced) __nonnull ((1, 2, 3));

  /** Return the field for custom type checks. */
  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_header_field (const char *__restrict fieldname) __nonnull ((1));

  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_entity_field (const char *__restrict name,
                           const char *__restrict fieldname) __nonnull ((1, 2));

  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_subclass_field (const char *__restrict name,
                             const char *__restrict fieldname)
      __nonnull ((1, 2));

  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_common_entity_field (const char *__restrict fieldname)
      __nonnull ((1));

  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_common_object_field (const char *__restrict fieldname)
      __nonnull ((1));

  /** Find the fields for this entity or object. */
  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_entity_fields (const char *__restrict name) __nonnull ((1));
  ...
  EXPORT const Dwg_DYNAPI_field *
  dwg_dynapi_subclass_fields (const char *__restrict name) __nonnull ((1));

  /** The sum of the size of all fields, by entity or subclass name */
  EXPORT int dwg_dynapi_fields_size (const char *__restrict name)
      __nonnull ((1));
...
#define dwg_get_OBJECT_DECL(name, OBJECT)                                     \
  EXPORT bool dwg_get_##OBJECT (const dwg_##name *__restrict name,              \
                                const char *__restrict fieldname,               \
                                void *__restrict out);                          \
  EXPORT bool dwg_set_##OBJECT (const dwg_##name *__restrict name,              \
                                const char *__restrict fieldname,               \
...
#define _deprecated_dynapi_common_setter                                      \
  ...
  EXPORT bool dwg_get_HEADER (const Dwg_Data *__restrict dwg,
                              const char *__restrict fieldname,
                              void *__restrict out) __nonnull ((1, 2, 3));
  EXPORT bool dwg_get_HEADER_utf8text (const Dwg_Data *__restrict dwg,
                                       const char *__restrict fieldname,
                                       char **__restrict textp, int *isnewp)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_set_HEADER (Dwg_Data *__restrict dwg,
                              const char *__restrict fieldname,
                              const void *__restrict value)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_set_HEADER_utf8text (Dwg_Data *__restrict dwg,
                                       const char *__restrict fieldname,
                                       const char *__restrict utf8)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_get_ENTITY_common (Dwg_Object_Entity *__restrict obj,
                                     const char *__restrict fieldname,
                                     void *__restrict value)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_get_ENTITY_common_utf8text (Dwg_Object_Entity *__restrict obj,
                                              const char *__restrict fieldname,
                                              char **__restrict textp,
                                              int *isnewp)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_get_OBJECT_common (Dwg_Object_Object *__restrict obj,
                                     const char *__restrict fieldname,
                                     void *__restrict value)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_get_OBJECT_common_utf8text (Dwg_Object_Object *__restrict obj,
                                              const char *__restrict fieldname,
                                              char **__restrict textp,
                                              int *isnewp)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_set_ENTITY_common (Dwg_Object_Entity *__restrict obj,
                                     const char *__restrict fieldname,
                                     const void *__restrict value)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_set_ENTITY_common_utf8text (Dwg_Object_Entity *__restrict obj,
                                              const char *__restrict fieldname,
                                              const char *__restrict utf8)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_set_OBJECT_common (Dwg_Object_Object *__restrict obj,
                                     const char *__restrict fieldname,
                                     const void *__restrict value)
      __nonnull ((1, 2, 3));
  EXPORT bool dwg_set_OBJECT_common_utf8text (Dwg_Object_Object *__restrict obj,
                                              const char *__restrict fieldname,
                                              const char *__restrict utf8)
      __nonnull ((1, 2, 3));
  ...
  EXPORT dwg_point_2d *dwg_ent_get_POINT2D (const void *__restrict _obj,
                                            const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_POINT2D (void *__restrict _obj,
                                   const char *__restrict fieldname,
                                   const dwg_point_2d *point)
      __nonnull ((1, 2, 3));

  EXPORT dwg_point_3d *dwg_ent_get_POINT3D (const void *__restrict _obj,
                                            const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_POINT3D (void *__restrict _obj,
                                   const char *__restrict fieldname,
                                   const dwg_point_3d *point)
      __nonnull ((1, 2, 3));

  EXPORT char *dwg_ent_get_STRING (const void *__restrict _obj,
                                   const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_STRING (void *__restrict _obj,
                                  const char *__restrict fieldname,
                                  const char *__restrict string)
      __nonnull ((1, 2, 3));

  EXPORT char *dwg_ent_get_UTF8 (const void *__restrict _obj,
                                 const char *__restrict fieldname, int *isnewp)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_UTF8 (void *__restrict _obj,
                                const char *__restrict fieldname,
                                const char *__restrict string)
      __nonnull ((1, 2, 3));

  EXPORT BITCODE_BD dwg_ent_get_REAL (const void *__restrict _obj,
                                      const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_REAL (void *__restrict _obj,
                                const char *__restrict fieldname,
                                const BITCODE_BD num) __nonnull ((1, 2));

  EXPORT BITCODE_BS dwg_ent_get_INT16 (const void *__restrict _obj,
                                       const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_INT16 (void *__restrict _obj,
                                 const char *__restrict fieldname,
                                 const BITCODE_BS num) __nonnull ((1, 2));

  EXPORT BITCODE_BL dwg_ent_get_INT32 (const void *__restrict _obj,
                                       const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_INT32 (void *__restrict _obj,
                                 const char *__restrict fieldname,
                                 const BITCODE_BL num) __nonnull ((1, 2));

  EXPORT char *dwg_ent_get_BINARY (const void *__restrict _obj,
                                   const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_BINARY (void *__restrict _obj,
                                  const char *__restrict fieldname,
                                  const char *string) __nonnull ((1, 2, 3));

  EXPORT BITCODE_H dwg_ent_get_HANDLE (const void *__restrict _obj,
                                       const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_HANDLE (void *__restrict _obj,
                                  const char *__restrict fieldname,
                                  const BITCODE_H handle)
      __nonnull ((1, 2, 3));

  EXPORT BITCODE_B dwg_ent_get_BOOL (const void *__restrict _obj,
                                     const char *__restrict fieldname)
      __nonnull ((1, 2));
  EXPORT bool dwg_ent_set_BOOL (void *__restrict _obj,
                                const char *__restrict fieldname,
...
#  endif /* USE_DEPRECATED_API */
  ...
  EXPORT BITCODE_BL dwg_object_polyline_2d_get_numpoints (
      const dwg_object *__restrict obj, int *__restrict error) __nonnull ((2));

  EXPORT dwg_point_2d *
  dwg_object_polyline_2d_get_points (const dwg_object *__restrict obj,
                                     int *__restrict error) __nonnull ((2));

  EXPORT BITCODE_BL dwg_object_polyline_3d_get_numpoints (
      const dwg_object *__restrict obj, int *__restrict error) __nonnull ((2));

  EXPORT dwg_point_3d *
  dwg_object_polyline_3d_get_points (const dwg_object *__restrict obj,
                                     int *__restrict error) __nonnull ((2));

  EXPORT double *
  dwg_ent_lwpline_get_bulges (const dwg_ent_lwpline *__restrict lwpline,
                              int *__restrict error) __nonnull ((2));

  EXPORT BITCODE_BL dwg_ent_lwpline_get_numpoints (
      const dwg_ent_lwpline *__restrict lwpline, int *__restrict error)
      __nonnull ((2));

  EXPORT dwg_point_2d *
  dwg_ent_lwpline_get_points (const dwg_ent_lwpline *__restrict lwpline,
                              int *__restrict error) __nonnull ((2));

  EXPORT int dwg_ent_lwpline_set_points (
      dwg_ent_lwpline *__restrict lwpline, const BITCODE_BL num_pts2d,
      const dwg_point_2d *__restrict pts2d) __nonnull_all;

  EXPORT dwg_lwpline_widths *
  dwg_ent_lwpline_get_widths (const dwg_ent_lwpline *__restrict lwpline,
                              int *__restrict error) __nonnull_all;
  ...
  */
  EXPORT char *
  dwg_obj_block_header_get_name (const dwg_obj_block_header *__restrict hdr,
                                 int *__restrict error)
    __nonnull ((2)) _deprecated_dynapi_getter;

  EXPORT dwg_obj_block_header *dwg_get_block_header (dwg_data *__restrict dwg,
                                                     int *__restrict error)
      __nonnull_all;
  ...
  EXPORT BITCODE_BL dwg_obj_block_control_get_num_entries (
      const dwg_obj_block_control *__restrict ctrl, int *__restrict error)
    __nonnull ((2));
  ...
  EXPORT char *dwg_obj_layer_get_name (const dwg_obj_layer *__restrict layer,
                                       int *__restrict error) __nonnull_all;
  EXPORT void dwg_obj_layer_set_name (dwg_obj_layer *__restrict layer,
                                      const char *__restrict name,
                                      int *__restrict error) __nonnull ((2, 3));
  ...
  EXPORT char *dwg_obj_table_get_name (const dwg_object *__restrict obj,
                                       int *__restrict error) __nonnull_all;

  // Get name of the referenced table entry. Defaults to ByLayer
  EXPORT char *dwg_ref_get_table_name (const dwg_object_ref *__restrict ref,
                                       int *__restrict error) __nonnull_all;

  // Get number of table entries from the table.
  EXPORT BITCODE_BL dwg_object_tablectrl_get_num_entries (
      const dwg_object *__restrict obj, int *__restrict error) __nonnull_all;

  // Get the nth table entry from the table.
  EXPORT dwg_object_ref *
  dwg_object_tablectrl_get_entry (const dwg_object *__restrict obj,
                                  const BITCODE_BS index, int *__restrict error)
      __nonnull ((3));

  // Get all table entries from the table.
  EXPORT dwg_object_ref **
  dwg_object_tablectrl_get_entries (const dwg_object *__restrict obj,
                                    int *__restrict error) __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_object_tablectrl_get_ownerhandle (const dwg_object *__restrict obj,
                                        int *__restrict error) __nonnull_all;
  EXPORT dwg_object_ref *
  dwg_object_tablectrl_get_xdicobjhandle (const dwg_object *__restrict obj,
                                          int *__restrict error) __nonnull_all;
  ...
  EXPORT dwg_object *dwg_ent_to_object (const dwg_obj_ent *__restrict obj,
                                        int *__restrict error) __nonnull_all;

  EXPORT dwg_object *dwg_ent_generic_to_object (const void *__restrict obj,
                                                int *__restrict error)
      __nonnull_all;
  EXPORT dwg_obj_ent *dwg_ent_generic_parent (const void *__restrict ent,
                                              int *__restrict error)
      __nonnull_all;

  EXPORT BITCODE_RL dwg_ent_get_bitsize (const dwg_obj_ent *__restrict ent,
                                         int *__restrict error) __nonnull_all;

  EXPORT BITCODE_BL dwg_ent_get_num_eed (const dwg_obj_ent *__restrict ent,
                                         int *__restrict error) __nonnull ((2));

  EXPORT dwg_entity_eed *dwg_ent_get_eed (const dwg_obj_ent *__restrict ent,
                                          BITCODE_BL index,
                                          int *__restrict error) __nonnull ((3));

  EXPORT dwg_entity_eed_data *
  dwg_ent_get_eed_data (const dwg_obj_ent *__restrict ent, BITCODE_BL index,
                        int *__restrict error) __nonnull ((3));

  EXPORT BITCODE_B dwg_ent_get_picture_exists (const dwg_obj_ent *__restrict ent,
                                               int *__restrict error)
    __nonnull_all;

  EXPORT BITCODE_BLL
  dwg_ent_get_picture_size (const dwg_obj_ent *__restrict ent,
                            int *__restrict error) // before r2007 only RL
      __nonnull_all;

  EXPORT BITCODE_TF dwg_ent_get_picture (const dwg_obj_ent *__restrict ent,
                                         int *__restrict error) __nonnull_all;

  EXPORT BITCODE_BB dwg_ent_get_entmode (const dwg_obj_ent *__restrict ent,
                                         int *__restrict error) __nonnull_all;

  EXPORT BITCODE_BL dwg_ent_get_num_reactors (const dwg_obj_ent *__restrict ent,
                                              int *__restrict error)
      __nonnull_all;

  EXPORT BITCODE_B
  dwg_ent_get_is_xdic_missing (const dwg_obj_ent *__restrict ent,
                               int *__restrict error) // r2004+
      __nonnull_all;

  EXPORT char *dwg_ent_get_layer_name (const dwg_obj_ent *__restrict ent,
                                       int *__restrict error) __nonnull_all;

  EXPORT char *dwg_ent_get_ltype_name (const dwg_obj_ent *__restrict ent,
                                       int *__restrict error) __nonnull_all;

  EXPORT BITCODE_B
  dwg_ent_get_isbylayerlt (const dwg_obj_ent *__restrict ent,
                           int *__restrict error) // r13-r14 only
      __nonnull_all;

  EXPORT BITCODE_B dwg_ent_get_nolinks (const dwg_obj_ent *__restrict ent,
                                        int *__restrict error) __nonnull_all;

  EXPORT const Dwg_Color *dwg_ent_get_color (const dwg_obj_ent *__restrict ent,
                                             int *__restrict error)
    __nonnull ((2));

  EXPORT double dwg_ent_get_linetype_scale (const dwg_obj_ent *__restrict ent,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT BITCODE_BB
  dwg_ent_get_linetype_flags (const dwg_obj_ent *__restrict ent,
                              int *__restrict error) // r2000+
      __nonnull_all;

  EXPORT BITCODE_BB
  dwg_ent_get_plotstyle_flags (const dwg_obj_ent *__restrict ent,
                               int *__restrict error) // r2000+
      __nonnull_all;

  EXPORT BITCODE_BB
  dwg_ent_get_material_flags (const dwg_obj_ent *__restrict ent,
                              int *__restrict error) // r2007+
      __nonnull_all;

  EXPORT BITCODE_RC dwg_ent_get_shadow_flags (const dwg_obj_ent *__restrict ent,
                                              int *__restrict error) // r2007+
      __nonnull_all;

  EXPORT BITCODE_B dwg_ent_has_full_visualstyle (dwg_obj_ent *__restrict ent,
                                                 int *__restrict error) // r2010+
      __nonnull_all;

  EXPORT BITCODE_B dwg_ent_has_face_visualstyle (dwg_obj_ent *__restrict ent,
                                                 int *__restrict error) // r2010+
      __nonnull_all;

  EXPORT BITCODE_B dwg_ent_has_edge_visualstyle (dwg_obj_ent *__restrict ent,
                                                 int *__restrict error) // r2010+
      __nonnull_all;

  EXPORT BITCODE_BS dwg_ent_get_invisible (const dwg_obj_ent *__restrict ent,
                                           int *__restrict error)
      __nonnull_all;

  /* See dxf_cvt_lweight() for the mm value */
  EXPORT BITCODE_RC dwg_ent_get_linewt (const dwg_obj_ent *__restrict ent,
                                        int *__restrict error) // r2000+
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_ownerhandle (const dwg_obj_ent *__restrict ent,
                           int *__restrict error) __nonnull_all;

  EXPORT dwg_object_ref **
  dwg_ent_get_reactors (const dwg_obj_ent *__restrict ent, int *__restrict error)
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_xdicobjhandle (const dwg_obj_ent *__restrict ent,
                             int *__restrict error) __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_prev_entity (const dwg_obj_ent *__restrict ent,
                           int *__restrict error) // r13-r2000
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_next_entity (const dwg_obj_ent *__restrict ent,
                           int *__restrict error) // r13-r2000
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_color_handle (const dwg_obj_ent *__restrict ent,
                            int *__restrict error) // r2004+
      __nonnull_all;

  EXPORT dwg_object_ref *dwg_ent_get_layer (const dwg_obj_ent *__restrict ent,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT dwg_object_ref *dwg_ent_get_ltype (const dwg_obj_ent *__restrict ent,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT dwg_object_ref *dwg_ent_get_material (const dwg_obj_ent *__restrict ent,
                                               int *__restrict error) // r2007+
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_plotstyle (const dwg_obj_ent *__restrict ent,
                         int *__restrict error) // r2000+
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_full_visualstyle (const dwg_obj_ent *__restrict ent,
                                int *__restrict error) // r2010+
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_face_visualstyle (const dwg_obj_ent *__restrict ent,
                                int *__restrict error) // r2010+
      __nonnull_all;

  EXPORT dwg_object_ref *
  dwg_ent_get_edge_visualstyle (const dwg_obj_ent *__restrict ent,
                                int *__restrict error) // r2010+
    __nonnull_all;

  EXPORT int
  dwg_ent_set_ltype (dwg_obj_ent *__restrict ent, const char *__restrict name)
    __nonnull_all;
  ...
  EXPORT dwg_object *dwg_obj_obj_to_object (const dwg_obj_obj *__restrict obj,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT BITCODE_BL dwg_obj_get_objid (const dwg_obj_obj *__restrict obj,
                                       int *__restrict error) __nonnull_all;

  EXPORT BITCODE_BL dwg_obj_get_num_eed (const dwg_obj_obj *__restrict obj,
                                         int *__restrict error) __nonnull_all;
  EXPORT dwg_entity_eed *dwg_obj_get_eed (const dwg_obj_obj *__restrict obj,
                                          const BITCODE_BL index,
                                          int *__restrict error) __nonnull ((3));
  EXPORT dwg_entity_eed_data *
  dwg_obj_get_eed_data (const dwg_obj_obj *__restrict obj,
                        const BITCODE_BL index, int *__restrict error)
      __nonnull ((3));

  EXPORT BITCODE_H dwg_obj_get_ownerhandle (const dwg_obj_obj *__restrict obj,
                                            int *__restrict error)
      __nonnull_all;
  EXPORT BITCODE_BL dwg_obj_get_num_reactors (const dwg_obj_obj *__restrict obj,
                                              int *__restrict error)
      __nonnull_all;
  EXPORT BITCODE_H *dwg_obj_get_reactors (const dwg_obj_obj *__restrict obj,
                                          int *__restrict error) __nonnull_all;
  EXPORT BITCODE_H dwg_obj_get_xdicobjhandle (const dwg_obj_obj *__restrict obj,
                                              int *__restrict error)
      __nonnull_all;
  /* r2004+ */
  EXPORT BITCODE_B dwg_obj_get_is_xdic_missing (
      const dwg_obj_obj *__restrict obj, int *__restrict error) __nonnull_all;
  /* r2013+ */
  EXPORT BITCODE_B dwg_obj_get_has_ds_binary_data (
      const dwg_obj_obj *__restrict obj, int *__restrict error) __nonnull_all;
  EXPORT Dwg_Handle *dwg_obj_get_handleref (const dwg_obj_obj *__restrict obj,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT dwg_object *dwg_obj_generic_to_object (const void *__restrict obj,
                                                int *__restrict error)
      __nonnull_all;
  EXPORT BITCODE_RLL dwg_obj_generic_handlevalue (void *_obj) __nonnull_all;
  Dwg_Data *dwg_obj_generic_dwg (const void *__restrict obj,
                                 int *__restrict error) __nonnull_all;
  EXPORT dwg_obj_obj *dwg_obj_generic_parent (const void *__restrict obj,
                                              int *__restrict error)
      __nonnull_all;
  ...
  EXPORT BITCODE_BL dwg_object_get_index (const dwg_object *__restrict obj,
                                          int *__restrict error) __nonnull_all;

  EXPORT dwg_handle *dwg_object_get_handle (dwg_object *__restrict obj,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT dwg_obj_obj *dwg_object_to_object (dwg_object *__restrict obj,
                                            int *__restrict error)
      __nonnull_all;

  EXPORT dwg_obj_ent *dwg_object_to_entity (dwg_object *__restrict obj,
                                            int *__restrict error)
      __nonnull_all;
  ...
  EXPORT BITCODE_BL dwg_ref_get_absref (const dwg_object_ref *__restrict ref,
                                        int *__restrict error) __nonnull_all;

  EXPORT dwg_object *dwg_ref_get_object (const dwg_object_ref *__restrict ref,
                                         int *__restrict error) __nonnull ((2));
  ...
  EXPORT int dwg_add_Document (Dwg_Data *__restrict dwg, const int imperial);

  /* Convert UTF-8 strings to BITCODE_T fields. Returns a copy of the string.
   */
  EXPORT BITCODE_T dwg_add_u8_input (Dwg_Data *__restrict dwg,
                                     const char *__restrict u8str) __nonnull_all;

  /* no proxy, no is_zombie */
  /* returns -1 on error, 0 on success */
  EXPORT int dwg_add_class (Dwg_Data *__restrict dwg,
                            const char *const __restrict dxfname,
                            const char *const __restrict cppname,
                            const char *const __restrict appname,
                            const bool is_entity) __nonnull ((1, 2, 3));
  /* check if already exists, and if not add dxfname-specific defaults */
  EXPORT int dwg_require_class (Dwg_Data *__restrict dwg,
                                const char *const __restrict dxfname,
                                const size_t len) __nonnull_all;
  /* insert entity into mspace, pspace or other block */
  EXPORT int dwg_insert_entity (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                                Dwg_Object *__restrict obj) __nonnull_all;

  /* Set defaults from HEADER: CLAYER, linewt, ltype_scale, color, ... */
  EXPORT int
  dwg_add_entity_defaults (Dwg_Data *__restrict dwg,
                           Dwg_Object_Entity *__restrict ent) __nonnull_all;
  ...
  */
  EXPORT bool
  dwg_is_valid_name (Dwg_Data *__restrict dwg, const char *__restrict name)
    __nonnull_all;
  ...
  dwg_add_TEXT (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                const char *__restrict text_value,
                const dwg_point_3d *__restrict ins_pt,
  ...
  */
  EXPORT Dwg_Entity_ATTRIB *dwg_add_Attribute (
      Dwg_Entity_INSERT *__restrict insert, const double height, const int flags,
      const char *__restrict prompt, const dwg_point_3d *__restrict ins_pt,
      const char *__restrict tag, const char *__restrict text_value) __nonnull_all;
  EXPORT Dwg_Entity_BLOCK *
  dwg_add_BLOCK (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const char *__restrict name) __nonnull_all;
  EXPORT Dwg_Entity_ENDBLK *
  dwg_add_ENDBLK (Dwg_Object_BLOCK_HEADER *__restrict blkhdr) __nonnull_all;
  EXPORT Dwg_Entity_SEQEND *
  dwg_add_SEQEND (dwg_ent_generic *__restrict owner) __nonnull_all;

  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_INSERT *
  dwg_add_INSERT (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                  const dwg_point_3d *__restrict ins_pt,
                  const char *__restrict name, const double xscale,
                  const double yscale, const double zscale,
                  const double rotation) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_MINSERT *dwg_add_MINSERT (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
      const dwg_point_3d *__restrict ins_pt, const char *__restrict name,
  ...
  dwg_add_POLYLINE_2D (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                       const int num_pts,
                       const dwg_point_2d *__restrict pts) __nonnull_all;
  EXPORT Dwg_Entity_POLYLINE_3D *
  dwg_add_POLYLINE_3D (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                       const int num_pts,
                       const dwg_point_3d *__restrict pts) __nonnull_all;
  /* invisible face edge if negative
     no 4th edge (ie a triangle) if the last face has index 0 (starts with 1)
  */
  EXPORT Dwg_Entity_POLYLINE_PFACE *
  dwg_add_POLYLINE_PFACE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                          const unsigned numverts, const unsigned numfaces,
                          const dwg_point_3d *__restrict verts,
                          const dwg_face *__restrict faces) __nonnull_all;
  EXPORT Dwg_Entity_POLYLINE_MESH *
  dwg_add_POLYLINE_MESH (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                         const unsigned num_m_verts,
                         const unsigned num_n_verts,
                         const dwg_point_3d *__restrict verts) __nonnull_all;
  EXPORT Dwg_Entity_ARC *dwg_add_ARC (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                                      const dwg_point_3d *__restrict center,
                                      const double radius,
                                      const double start_angle,
                                      const double end_angle) __nonnull_all;
  EXPORT Dwg_Entity_ATTDEF *dwg_add_ATTDEF (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr, const double height,
      const int mode, const char *__restrict prompt,
      const dwg_point_3d *__restrict ins_pt, const char *__restrict tag,
      const char *__restrict default_value) __nonnull_all;
  EXPORT Dwg_Entity_ATTRIB *
  dwg_add_ATTRIB (Dwg_Entity_INSERT *__restrict insert, const double height,
                  const int flags, const dwg_point_3d *__restrict ins_pt,
                  const char *__restrict tag,
                  const char *__restrict text_value) __nonnull_all;
  EXPORT Dwg_Entity_CIRCLE *
  dwg_add_CIRCLE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                  const dwg_point_3d *__restrict center,
                  const double radius) __nonnull_all;
  EXPORT Dwg_Entity_LINE *
  dwg_add_LINE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                const dwg_point_3d *__restrict start_pt,
                const dwg_point_3d *__restrict end_pt) __nonnull_all;
  EXPORT Dwg_Entity_DIMENSION_ALIGNED *dwg_add_DIMENSION_ALIGNED (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
      const dwg_point_3d *__restrict xline1_pt,
      const dwg_point_3d *__restrict xline2_pt,
      const dwg_point_3d *__restrict text_pt) __nonnull_all;
  EXPORT Dwg_Entity_DIMENSION_ANG2LN * /* DimAngular */
  dwg_add_DIMENSION_ANG2LN (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                            const dwg_point_3d *__restrict center_pt,
                            const dwg_point_3d *__restrict xline1end_pt,
                            const dwg_point_3d *__restrict xline2end_pt,
                            const dwg_point_3d *__restrict text_pt)
      __nonnull_all;
  ...
  dwg_add_DIMENSION_DIAMETER (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                              const dwg_point_3d *__restrict chord_pt,
                              const dwg_point_3d *__restrict far_chord_pt,
                              const double leader_len) __nonnull_all;
  EXPORT Dwg_Entity_DIMENSION_ORDINATE *dwg_add_DIMENSION_ORDINATE (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
      const dwg_point_3d *__restrict def_pt, /* = feature_location_pt */
      const dwg_point_3d *__restrict leader_endpt,
      const bool use_x_axis) __nonnull_all;
  EXPORT Dwg_Entity_DIMENSION_RADIUS *
  dwg_add_DIMENSION_RADIUS (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                            const dwg_point_3d *__restrict center_pt,
                            const dwg_point_3d *__restrict chord_pt,
                            const double leader_len) __nonnull_all;
  EXPORT Dwg_Entity_DIMENSION_LINEAR * /* Rotated */
  dwg_add_DIMENSION_LINEAR (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                            const dwg_point_3d *__restrict xline1_pt,
                            const dwg_point_3d *__restrict xline2_pt,
                            const dwg_point_3d *__restrict def_pt,
                            const double rotation_angle) __nonnull_all;
  EXPORT Dwg_Entity_POINT *
  dwg_add_POINT (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict pt) __nonnull_all;
  EXPORT Dwg_Entity__3DFACE *
  dwg_add_3DFACE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                  const dwg_point_3d *__restrict pt1,
                  const dwg_point_3d *__restrict pt2,
                  const dwg_point_3d *__restrict pt3,
                  const dwg_point_3d *__restrict pt4 /* may be NULL */)
      __nonnull ((1, 2, 3, 4));
  EXPORT Dwg_Entity_SOLID *
  dwg_add_SOLID (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict pt1,
                 const dwg_point_2d *__restrict pt2,
                 const dwg_point_2d *__restrict pt3,
                 const dwg_point_2d *__restrict pt4) __nonnull_all;
  EXPORT Dwg_Entity_TRACE *
  dwg_add_TRACE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict pt1,
                 const dwg_point_2d *__restrict pt2,
                 const dwg_point_2d *__restrict pt3,
                 const dwg_point_2d *__restrict pt4) __nonnull_all;
  ...
  dwg_add_SHAPE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const char *__restrict name,
                 const dwg_point_3d *__restrict ins_pt, const double scale,
                 const double oblique_angle) __nonnull_all;
  EXPORT Dwg_Entity_VIEWPORT *
  dwg_add_VIEWPORT (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                    const char *__restrict name) __nonnull_all;
  EXPORT Dwg_Entity_ELLIPSE *
  dwg_add_ELLIPSE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                   const dwg_point_3d *__restrict center,
                   const double major_axis,
                   const double axis_ratio) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_SPLINE *
  dwg_add_SPLINE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                  const int num_fit_pts, const dwg_point_3d *__restrict fit_pts,
                  const dwg_point_3d *__restrict beg_tan_vec,
                  const dwg_point_3d *__restrict end_tan_vec) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_REGION *
  dwg_add_REGION (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                  const char *acis_data) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_3DSOLID (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                   const char *acis_data) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_BODY *
  dwg_add_BODY (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                const char *acis_data) __nonnull_all;
  /* TODO VBA has two points, not a vector */
  EXPORT Dwg_Entity_RAY *
  dwg_add_RAY (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
               const dwg_point_3d *__restrict point,
               const dwg_point_3d *__restrict vector) __nonnull_all;
  EXPORT Dwg_Entity_XLINE *
  dwg_add_XLINE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict point,
                 const dwg_point_3d *__restrict vector) __nonnull_all;

  EXPORT Dwg_Object_DICTIONARY *
  dwg_add_DICTIONARY (Dwg_Data *__restrict dwg,
                      const char *__restrict name, /* the NOD entry */
                      const char *__restrict text, /* maybe NULL */
  ...
  dwg_add_DICTIONARYWDFLT (Dwg_Data *__restrict dwg,
                           const char *__restrict name, /* the NOD entry */
                           const char *__restrict text, /* maybe NULL */
                           const BITCODE_RLL absolute_ref) __nonnull ((1));
  EXPORT Dwg_Entity_OLE2FRAME *
  dwg_add_OLE2FRAME (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                     const dwg_point_3d *__restrict pt1,
                     const dwg_point_3d *__restrict pt2) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_MTEXT *
  dwg_add_MTEXT (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict ins_pt, const double rect_width,
                 const char *__restrict text_value /*UTF-8*/) __nonnull_all;
  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_LEADER *dwg_add_LEADER (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr, const unsigned num_points,
      const dwg_point_3d *__restrict points,
      const Dwg_Entity_MTEXT *__restrict associated_annotation, /* maybe NULL */
      const unsigned type) __nonnull ((1, 3));
  EXPORT Dwg_Entity_TOLERANCE *
  dwg_add_TOLERANCE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                     const char *__restrict text_value,
                     const dwg_point_3d *__restrict ins_pt,
                     const dwg_point_3d *__restrict x_direction /* maybe NULL */)
      __nonnull ((1, 2, 3));
  EXPORT Dwg_Entity_MLINE *
  dwg_add_MLINE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const unsigned num_verts,
                 const dwg_point_3d *__restrict verts) __nonnull_all;

  EXPORT Dwg_Entity_LWPOLYLINE *
  dwg_add_LWPOLYLINE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                      const int num_pts2d,
                      const dwg_point_2d *__restrict pts2d) __nonnull_all;

  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Entity_HATCH *
  dwg_add_HATCH (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const int pattern_type, const char *__restrict name,
  ...
  dwg_add_XRECORD (Dwg_Object_DICTIONARY *__restrict dict,
                   const char *__restrict keyword) __nonnull_all;
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_bool (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                        const BITCODE_B value) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_int8 (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                        const BITCODE_RC value) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_int16 (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                         const BITCODE_BS value) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_int32 (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                         const BITCODE_BL value) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_int64 (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                         const BITCODE_BLL value) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_real (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                        const BITCODE_BD value) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_pointd3d (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                            const BITCODE_3DPOINT *pt) __nonnull ((1));
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_binary (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                          const int size,
                          const BITCODE_RC *data) __nonnull_all;
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_string (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                          const BITCODE_BS len,
                          const char *__restrict str) __nonnull_all;
  EXPORT Dwg_Object_XRECORD *
  dwg_add_XRECORD_handle (Dwg_Object_XRECORD *__restrict _obj, const short dxf,
                          const Dwg_Handle hdl) __nonnull_all;

  EXPORT Dwg_Object_PLACEHOLDER *
  dwg_add_PLACEHOLDER (Dwg_Data *__restrict dwg) __nonnull_all;
  EXPORT Dwg_Object_VBA_PROJECT *
  dwg_add_VBA_PROJECT (Dwg_Data *__restrict dwg, const BITCODE_BL size,
                       const BITCODE_RC *data) __nonnull_all;
  /* Either added to mspace, pspace, or VIEWPORT entity in pspace, or VPORT
   * object in mspace. */
  EXPORT Dwg_Object_LAYOUT *
  dwg_add_LAYOUT (Dwg_Object *__restrict vp, const char *__restrict name,
                  const char *__restrict canonical_media_name) __nonnull_all;

  /* Experimental. Does not work yet properly. */
  // Called Raster in VBA
  EXPORT Dwg_Entity_IMAGE *dwg_add_IMAGE (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr, const char *__restrict file_path,
      const dwg_point_3d *__restrict ins_pt, const double scale_factor,
      const double rotation_angle) __nonnull_all;

  EXPORT Dwg_Entity_LARGE_RADIAL_DIMENSION *
  dwg_add_LARGE_RADIAL_DIMENSION (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                                  const dwg_point_3d *__restrict center_pt,
                                  const dwg_point_3d *__restrict first_arc_pt,
                                  const dwg_point_3d *__restrict ovr_center,
                                  const dwg_point_3d *__restrict jog_point,
                                  const double leader_len) __nonnull_all;

  /* Experimental. Does not work yet properly. */
  EXPORT Dwg_Entity_PDFUNDERLAY *dwg_add_PDFUNDERLAY (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr, const char *__restrict filename,
      const dwg_point_3d *__restrict ins_pt, const double scale_factor,
      const double rotation_angle) __nonnull_all;
  ...
  dwg_add_ACSH_BOX_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                          const dwg_point_3d *__restrict origin_pt,
                          const dwg_point_3d *__restrict normal,
                          const double length, const double width,
                          const double height) __nonnull_all;
  EXPORT Dwg_Object_ACSH_CHAMFER_CLASS *dwg_add_ACSH_CHAMFER_CLASS (
      Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
      const dwg_point_3d *__restrict origin_pt,
      const dwg_point_3d *__restrict normal, const int bl92,
  ...
  dwg_add_ACSH_CONE_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                           const dwg_point_3d *__restrict origin_pt,
                           const dwg_point_3d *__restrict normal,
  ...
  dwg_add_ACSH_CYLINDER_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                               const dwg_point_3d *__restrict origin_pt,
                               const dwg_point_3d *__restrict normal,
                               const double height, const double major_radius,
                               const double minor_radius,
  ...
  dwg_add_ACSH_PYRAMID_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                              const dwg_point_3d *__restrict origin_pt,
                              const dwg_point_3d *__restrict normal,
  ...
  dwg_add_ACSH_SPHERE_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                             const dwg_point_3d *__restrict origin_pt,
                             const dwg_point_3d *__restrict normal,
                             const double radius) __nonnull_all;
  EXPORT Dwg_Object_ACSH_TORUS_CLASS *
  dwg_add_ACSH_TORUS_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                            const dwg_point_3d *__restrict origin_pt,
                            const dwg_point_3d *__restrict normal,
                            const double major_radius,
                            const double minor_radius) __nonnull_all;
  EXPORT Dwg_Object_ACSH_WEDGE_CLASS *
  dwg_add_ACSH_WEDGE_CLASS (Dwg_Object_EVALUATION_GRAPH *__restrict evalgraph,
                            const dwg_point_3d *__restrict origin_pt,
                            const dwg_point_3d *__restrict normal,
                            const double length, const double width,
                            const double height) __nonnull_all;
  EXPORT Dwg_Object_EVALUATION_GRAPH *
  dwg_add_EVALUATION_GRAPH (Dwg_Data *__restrict dwg, const int has_graph,
                            const int nodeid, const unsigned num_evalexpr,
                            const BITCODE_H *__restrict evalexpr)
      __nonnull ((1));
  EXPORT Dwg_Object_ACSH_HISTORY_CLASS *
  dwg_add_ACSH_HISTORY_CLASS (Dwg_Entity_3DSOLID *__restrict region,
                              const int h_nodeid) __nonnull_all;

  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_BOX (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
               const dwg_point_3d *__restrict origin_pt,
               const dwg_point_3d *__restrict normal, /* maybe NULL */
               const double length, const double width, const double height)
      __nonnull ((1, 2));

  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_CONE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                const dwg_point_3d *__restrict origin_pt,
                const dwg_point_3d *__restrict normal, /* maybe NULL */
                const double height, const double major_radius,
      ...
      __nonnull ((1, 2));
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_CYLINDER (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                    const dwg_point_3d *__restrict origin_pt,
                    const dwg_point_3d *__restrict normal, /* maybe NULL */
                    const double height, const double major_radius,
                    const double minor_radius, const double x_radius)
  ...
  //                              __nonnull ((1,2));
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_EXTRUDED_SOLID (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                          const Dwg_Object *__restrict profile,
                          const double height,
                          const double taper_angle) __nonnull_all;
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_EXTRUDED_PATH (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                         const Dwg_Object *__restrict profile,
                         const double height,
                         const double taper_angle) __nonnull_all;
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_PYRAMID (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                   const dwg_point_3d *__restrict origin_pt,
                   const dwg_point_3d *__restrict normal, /* maybe NULL */
  ...
  EXPORT Dwg_Entity_3DSOLID *dwg_add_REVOLVED_SOLID (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
      const Dwg_Object *__restrict profile, const dwg_point_3d *__restrict axis_pt,
      const dwg_point_3d *__restrict axis_dir, const double angle) __nonnull_all;
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_SPHERE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                  const dwg_point_3d *__restrict origin_pt,
                  const dwg_point_3d *__restrict normal, /* maybe NULL */
                  const double radius) __nonnull ((1, 2));
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_TORUS (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict origin_pt,
                 const dwg_point_3d *__restrict normal, /* maybe NULL */
                 const double torus_radius, const double tube_radius)
      __nonnull ((1, 2));
  EXPORT Dwg_Entity_3DSOLID *
  dwg_add_WEDGE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict origin_pt,
                 const dwg_point_3d *__restrict normal, /* maybe NULL */
                 const double length, const double width, const double height)
      __nonnull ((1, 2));
  ...
  dwg_add_TABLE (Dwg_Object_BLOCK_HEADER *__restrict blkhdr,
                 const dwg_point_3d *__restrict ins_pt,
                 const int num_rows,
                 const int num_cols,
  ...
  */
  ...
  dwg_add_BLOCK_CONTROL (Dwg_Data *__restrict dwg, const unsigned ms,
                         const unsigned ps) __nonnull_all;

  EXPORT Dwg_Object_BLOCK_HEADER *
  dwg_add_BLOCK_HEADER (Dwg_Data *__restrict dwg, const char *__restrict name)
    __nonnull ((1));
  EXPORT Dwg_Object_UCS *
  dwg_add_UCS (Dwg_Data *__restrict dwg, const dwg_point_3d *__restrict origin,
               const dwg_point_3d *__restrict x_axis,
               const dwg_point_3d *__restrict y_axis, const char *__restrict name)
      __nonnull ((1));
  EXPORT Dwg_Object_LAYER *
  dwg_add_LAYER (Dwg_Data *__restrict dwg,
                 const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_STYLE *
  dwg_add_STYLE (Dwg_Data *__restrict dwg,
                 const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_LTYPE *
  dwg_add_LTYPE (Dwg_Data *__restrict dwg,
                 const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_VIEW *
  dwg_add_VIEW (Dwg_Data *__restrict dwg,
                const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_DIMSTYLE *
  dwg_add_DIMSTYLE (Dwg_Data *__restrict dwg,
                    const char *__restrict name /* maybe NULL */)
      __nonnull ((1));
  EXPORT Dwg_Object_VPORT *
  dwg_add_VPORT (Dwg_Data *__restrict dwg,
                 const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_VX_TABLE_RECORD *
  dwg_add_VX (Dwg_Data *__restrict dwg,
              const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_APPID *
  dwg_add_APPID (Dwg_Data *__restrict dwg,
                 const char *__restrict name /* maybe NULL */) __nonnull ((1));
  EXPORT Dwg_Object_GROUP *
  dwg_add_GROUP (Dwg_Data *__restrict dwg,
                 const char *__restrict name /* maybe NULL */) __nonnull ((1));

  /* Experimental. Does not work yet properly */
  EXPORT Dwg_Object_MLINESTYLE *
  dwg_add_MLINESTYLE (Dwg_Data *__restrict dwg,
                      const char *__restrict name) __nonnull_all;

  /* Experimental API's. Will change. */
  EXPORT Dwg_Object_PROXY_OBJECT *
  dwg_add_PROXY_OBJECT (Dwg_Data *__restrict dwg, char *name, char *key
                        /*, size, data */) __nonnull_all;
  EXPORT Dwg_Entity_PROXY_ENTITY *dwg_add_PROXY_ENTITY (
      Dwg_Object_BLOCK_HEADER *__restrict blkhdr /* ... */) __nonnull_all;
  EXPORT Dwg_Object_LAYERFILTER *
  dwg_add_LAYERFILTER (Dwg_Data *__restrict dwg /* ... */) __nonnull_all;
  EXPORT Dwg_Object_LAYER_INDEX *
  dwg_add_LAYER_INDEX (Dwg_Data *__restrict dwg /* ... */) __nonnull_all;
  EXPORT Dwg_Object_SPATIAL_FILTER *dwg_add_SPATIAL_FILTER (
      Dwg_Entity_INSERT *__restrict insert /*, clip_verts... */) __nonnull_all;
  EXPORT Dwg_Object_SPATIAL_INDEX *
  dwg_add_SPATIAL_INDEX (Dwg_Data *__restrict dwg /* ... */) __nonnull_all;
